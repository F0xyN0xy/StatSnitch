...
class Storage:
    ...
    def track_message(self, user_id: str, username: str, content: str,
                      has_attachment: bool, timestamp: datetime) -> None:
        ...
        # Content analysis
        self._analyse_content(u, content)
    ...
    def _analyse_content(self, u: dict, content: str) -> None:
        import re
        ...
        # Punctuation
        u["question_marks"]    += content.count("?")
        u["exclamation_marks"] += content.count("!")
        ...
        raw_words = re.findall(r"[a-zA-Z']+", content.lower())
        for w in raw_words:
